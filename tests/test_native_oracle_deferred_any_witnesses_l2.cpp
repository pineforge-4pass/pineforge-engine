// Exact native-route twin of the L0 deferred-ANY witness oracle. The body is
// included verbatim so its legacy-captured literals cannot drift independently.
...
#include "oracle/test_oracle_deferred_any_witnesses.cpp"
