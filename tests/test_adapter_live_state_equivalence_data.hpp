...
constexpr std::uint64_t kTranscriptDigests[] = {
    ...
    4811666956682998059ull,  // reversals seed 1152019, 151 trades, 397 commands, 409 rows placed
    ...
    11664346520909115979ull,  // brackets seed 314188, 145 trades, 850 commands, 981 rows placed
    ...
    1550055039614354387ull,  // brackets seed 1780394, 95 trades, 697 commands, 705 rows placed
    ...
    2136070886124345893ull,  // brackets seed 3246600, 115 trades, 657 commands, 847 rows placed
    ...
    5640170146031748940ull,  // chains seed 314189, 107 trades, 526 commands, 454 rows placed
    ...
    17828078233634427072ull,  // chains seed 3246601, 98 trades, 485 commands, 466 rows placed
