...
public:
    RiskTestStrategy() {
        ...
        commission_value_ = 0.0;
        slippage_ = 0;
        set_pine_risk_max_position_size(2.0); // max 2 units
        pyramiding_ = 5;
    }
...
static void test_blocked_entry_does_not_consume_intraday_fill_quota() {
    ...
    public:
        Strat() {
            ...
            pyramiding_ = 10;
            risk_direction_ = RiskDirection::LONG_ONLY;
            set_pine_risk_max_position_size(2.0);
            adapter_.cap = 3;
        }
        void on_source_bar(const Bar& bar) override {
...
public:
    ...
    RiskHaltStrategy() {
        ...
        commission_value_ = 0.0;
        slippage_ = 0;
        set_pine_risk_max_drawdown(500, false);
    }
    void on_source_bar(const Bar& bar) override {
        entries_attempted++;
...
static void test_qty_percent_of_equity_includes_open_profit_for_pyramid_add() {
    ...
    public:
        ...
        double calc_add_qty() {
            ...
            return (initial_capital_ + (110.0 - position_entry_price_) * position_qty_)
                * default_qty_value_ / 100.0 / 110.0;
        }
        void on_source_bar(const Bar&) override {}
    } strat;
