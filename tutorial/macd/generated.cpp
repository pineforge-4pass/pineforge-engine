// AUTO-GENERATED by pineforge-codegen from strategy.pine.
// Regenerate with `tutorial/macd/regen.sh` (requires sibling
// pineforge-codegen checkout). Do not hand-edit.
