...
public:
    ...
    void on_source_bar(const Bar& bar) override {
        ...
        auto _result__ta_macd_1 = (is_first_tick() ? _ta_macd_1.compute(src) : _ta_macd_1.recompute(src));
        ...
        longCond = (is_first_tick() ? _ta_crossover_2.compute(macdLine, signalLine) : _ta_crossover_2.recompute(macdLine, signalLine));
        shortCond = (is_first_tick() ? _ta_crossunder_3.compute(macdLine, signalLine) : _ta_crossunder_3.recompute(macdLine, signalLine));
        if (longCond) {
