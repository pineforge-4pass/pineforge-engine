...
| the rich-`run` paragraph | the rich `run` overload fails a native host | `run_rich` native_execution_consumer.cpp:8195-8233 shows no such refusal (still unpinned by a test; the page says so) |
