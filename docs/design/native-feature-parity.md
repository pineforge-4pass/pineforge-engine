...
writes are `close_cause` pine_strategy_host.cpp:489, `exit_bar_index` :826, `exit_comment` :617, `close_cause` :631-636, `exit_from_bracket` :1247 and `entry_incarnation` :1428-1436.
