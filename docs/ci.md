...
missing label fails. The PR registration floors at INT27 are 687 for Debug
and sanitizers and 696 for native (653 and 662 at the INT24 base, plus wave G's
six rows, wave H's twenty-four, INT26's own tape row and the K-RUNERR,
PERF-ZONED and TV-DEFAULTS rows). The full-run release and kernel floors are
706 and 287 rows that ran; full runs do not exclude a label.
