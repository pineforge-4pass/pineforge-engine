...
(`src/source/pine_adapter.cpp:5290`) returns at its receipt gate when no
...
- **PERF-L4's retired reader slots.** `event_high_water_reader_` and
  ...
  (`include/pineforge/source/pine_adapter.hpp:1920-1921`), with their type
