...
ARTIFACTS = {
    ...
    "native-abi-v18-frozen/receipt.json": "native-abi-v18-frozen-receipt.json",
    "native-abi-v18-frozen/configure.log": "native-abi-v18-frozen-configure.log",
    "native-abi-v18-frozen/build.log": "native-abi-v18-frozen-build.log",
